...
public class PanelValoracionMateria extends JPanel {
	...
	private List<PanelValoracionMateriaIndividual> l = new ArrayList<PanelValoracionMateriaIndividual>();
	...
	private void refrescarAlumnado() {
		List<Estudiante> estudiantes = ControladorEstudiante.getTodos();
		...
		for (Estudiante estudiante : estudiantes) {
			PanelValoracionMateriaIndividual panel = new PanelValoracionMateriaIndividual(profSeleccionado, estudiante,matSeleccionada);
...
// comprobar si existe nota, hacer insert o modificacion.
	private void guardar() {
		for (PanelValoracionMateriaIndividual panelValoracionesIndividual : this.l) {
